class User {
    constructor (public id: number, private name: string, private surname: string, private email: string, private phone: number) {}
}
...
const filter_users: User[] = users_array.filter(filterUsers);
